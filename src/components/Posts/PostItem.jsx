...
export const PostItem = ({body,title,id,userId}) =>{
    ...
    let url = "https://img.uxwing.com/wp-content/themes/uxwing/download/emoji-emoticon/smile-icon.png";
    ...
    const redirect = () => {
        navigate('/AboutMe',{state:{body,title,id,userId}})
    }
    ...
    console.log(toggleComments,showA);
    return(
    <ListGroup.Item style={fullHD?styles.fullHD:middle?styles.middle:styles.small}>
        <Card style={{padding:"1vh 2vw" }}>
            ...
            src={url} onClick={()=>redirect()} />
                <Card.Body style={{backgroundColor:"yellow",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
