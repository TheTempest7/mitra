...
<Navbar  bg="primary" expand="true">  
    <Container>  
        ...
        <Toast style={styles.toast} show={showA} onClose={toggleShowA}>
            <Nav className="me-auto">  
                <Toast.Body style={styles.toastBody}>
                    <svg onClick={()=>sortTitlePost()} style={styles.svg} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 272.383 272.383" xmlSpace="preserve">  
                    <g>
	                    <g>
		                    <path style={styles.path} d="M223.214,152.723h-32.237c16.306-20.152,26.76-47.195,26.76-71.415
        ...
        <Form className="d-flex">
            <Form.Control style={tiny?styles.searchBar:styles.searchBarPlug}
